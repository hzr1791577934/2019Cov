...
def get_tencent_data():
    ...
    r_2 = requests.get(url_2,headers)
    res = json.loads(r.text)  # json字符串转字典
    res_2 = json.loads(r_2.text)
    data_all = json.loads(res['data'])
    data_all_2 = json.loads(res_2['data'])
    print(data_all.keys())
    print(data_all_2.keys())
    ...
    details = []  # 当日详细数据
    update_time = data_all_2["lastUpdateTime"]
    data_country = data_all_2["areaTree"]  # list 25个国家
